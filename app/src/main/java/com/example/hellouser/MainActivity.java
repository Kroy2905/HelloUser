...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // textEditText = findViewById(R.id.activity_main_textToSpeech);
...
public class MainActivity extends AppCompatActivity {
    private static final String API_KEY = "Q3ZXKKHCJzjViVQhbbdkHoUOpqW_Lp_tANPROVhdqeCN";
